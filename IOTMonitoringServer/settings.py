...
ALLOWED_HOSTS = ["localhost", "ec2-52-91-86-36.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-54-86-25-83.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-35-173-221-158.compute-1.amazonaws.com"
