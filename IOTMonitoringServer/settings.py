...
ALLOWED_HOSTS = ["localhost", "ec2-52-90-200-77.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-52-91-212-95.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-86-102-137.compute-1.amazonaws.com"
