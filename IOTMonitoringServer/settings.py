...
ALLOWED_HOSTS = ["localhost", "ec2-34-230-37-220.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-3-89-89-0.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-18-204-21-219.compute-1.amazonaws.com"
