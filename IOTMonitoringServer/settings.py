...
ALLOWED_HOSTS = ["localhost", "ec2-52-206-208-4.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-3-87-211-43.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-100-26-203-11.compute-1.amazonaws.com"
