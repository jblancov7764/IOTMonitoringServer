...
ALLOWED_HOSTS = ["localhost", "ec2-18-234-99-11.compute-1.amazonaws.com"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "ec2-54-172-171-240.compute-1.amazonaws.com",  # Dirección IP de la base de datos
...
MQTT_HOST = "ec2-3-84-190-16.compute-1.amazonaws.com"
